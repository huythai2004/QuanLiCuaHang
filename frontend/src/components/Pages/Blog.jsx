...
import productMin01 from "../../images/product-min-01.jpg";
import productMin02 from "../../images/product-min-02.jpg";
import productMin03 from "../../images/product-min-03.jpg";
          ...
          <div className="row">
            <div className="col-md-8 col-lg-9 p-b-80">
              <div className="p-r-45 p-r-0-lg">
                ...
                <div className="p-b-63">
                  ...
                  <div className="p-t-32">
                    ...
                    <div className="flex-w flex-sb-m p-t-18">
                      ...
                      <Link to="/blog-details" className="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                        Continue Reading
                ...
                {/* Item Blog */}
                <div className="p-b-63">
                  <Link to="/blog-details" className="hov-img0 how-pos5-parent">
                    <img src={blog05} alt="IMG-BLOG" />
                    <div className="flex-col-c-m size-123 bg9 how-pos5">
                      <span className="ltext-107 cl2 txt-center">18</span>
                      <span className="stext-109 cl3 txt-center">Jan 2025</span>
                    </div>
                  </Link>

                  <div className="p-t-32">
                    <h4 className="p-b-15">
                      <Link to="/blog-details" className="ltext-108 cl2 hov-cl1 trans-04">
