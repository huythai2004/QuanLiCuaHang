      ...
      <section className="bg0 p-t-23 p-b-140">
        ...
        <div className="flex-w flex-sb-m p-b-52">
          ...
          <div className="flex-w flex-l-m filter-tope-group m-tb-10">
            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "*" ? "how-active1" : ""}`}
            ...
            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "women" ? "how-active1" : ""}`}
            ...
            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "men" ? "how-active1" : ""}`}
            ...
            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "bag" ? "how-active1" : ""}`}
              onClick={() => handleCategoryFilter("bag")}
            >
              Bag
            </button>

            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "shoes" ? "how-active1" : ""}`}
            ...
            <button
              className={`stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${activeFilter === "watches" ? "how-active1" : ""}`}
          ...
          <div className="flex-w flex-c-m m-tb-10">
            <div 
              className={`flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn3 trans-04 m-r-8 m-tb-4 ${showFilterPanel ? "show-filter" : ""}`}
              onClick={toggleFilterPanel}
            >
              <i className={`icon-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-filter-list ${showFilterPanel ? "dis-none" : ""}`}></i>
              <i className={`icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close ${showFilterPanel ? "" : "dis-none"}`}></i>
              Filter
            </div>

            <div 
              className={`flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn3 trans-04 m-tb-4 ${showSearchPanel ? "show-search" : ""}`}
              onClick={toggleSearchPanel}
            >
              <i className={`icon-search cl2 m-r-6 fs-15 trans-04 zmdi zmdi-search ${showSearchPanel ? "dis-none" : ""}`}></i>
              <i className={`icon-close-search cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close ${showSearchPanel ? "" : "dis-none"}`}></i>
              Search
            </div>
          </div>
            ...
            >
              <div className="block2">
                <div className="block2-pic hov-img0">
                  <img 
                    src={product.primary_image || product.images?.[0]?.image_url || require('../images/product-01.jpg')} 
                    alt={product.name}
                    onError={(e) => {
