...
export default function Contact() {
  return (
    <div>
      {/* Title page */}
	<section className="bg-img1 txt-center p-lr-15 p-tb-92" style={{backgroundImage: `url(${Images})`}}>
				...
				<div className="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<div>
						...
						<div className="bor8 m-b-20 how-pos4-parent">
							...
							<img className="how-pos4 pointer-none" src={Email} alt="ICON"/>
						</div>
